...
class YumUser extends YumActiveRecord
{
	...
	public function rules()
	{
		...
		$rules[] = array('username, createtime, lastvisit, lastpasswordchange, superuser, status,organizacion_id', 'required');
		...
		if($relations === false) {
			...
			if (Yum::hasModule('membership')) {
				...
				$relations['memberships'] = array(
                        ...
                        $relations['organizacion'] = array(
						self::HAS_ONE, 'Organizacion', 'organizacion_id');
