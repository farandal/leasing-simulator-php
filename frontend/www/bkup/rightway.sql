...
--
-- Servidor: localhost
-- Tiempo de generación: 04-12-2012 a las 13:33:40
...
(7, 'crear_prospecto', 'Crear Prospecto', NULL);
...
INSERT INTO `costo` (`id`, `nombre`, `tipo`, `valor`) VALUES
(1, 'ppm', 2, 1.15),
(2, 'inscripcion', 1, 3),
(3, 'contabilidad', 1, 3),
(4, 'notaria', 1, 3),
(5, 'meratenencia', 1, 1),
(6, 'transferencia', 2, 1.79),
(7, 'legal_venta', 1, 25);
...
CREATE TABLE IF NOT EXISTS `estado` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'hidden',
  `code` varchar(32) NOT NULL COMMENT 'list,required',
  `name` varchar(255) NOT NULL COMMENT 'list',
  PRIMARY KEY (`id`),
...
INSERT INTO `estado` (`id`, `code`, `name`) VALUES
(1, 'N', 'Nuevo'),
(2, 'U', 'Usado');
...
--
-- Volcar la base de datos para la tabla `friendship`
--
...
--
-- Volcar la base de datos para la tabla `membership`
--
...
INSERT INTO `moneda` (`id`, `nombre`, `valor`, `fecha`) VALUES
(1, 'CLP', 1, '0000-00-00 00:00:00'),
(2, 'USD', 481.28, '2012-12-04 09:22:03'),
(3, 'UF', 22899.3, '2012-12-04 09:22:03');
...
CREATE TABLE IF NOT EXISTS `organizacion` (
  ...
  `name` varchar(32) NOT NULL COMMENT 'list,required,email',
  `description` varchar(255) NOT NULL COMMENT 'list',
...
INSERT INTO `organizacion` (`id`, `created`, `status`, `name`, `description`, `autor`, `image`) VALUES
(1, '0000-00-00 00:00:00', 1, 'rway', 'RightWay', 0, NULL),
(2, '0000-00-00 00:00:00', 1, 'kaufmann', 'Empresas Kaufmann', 0, NULL),
(15, '2012-11-12 16:26:22', 1, 'Test', 'Test', 0, '.jpg');
...
--
-- Estructura de tabla para la tabla `privacysetting`
--
...
--
-- Volcar la base de datos para la tabla `privacysetting`
--
...
(1, 1, '2012-10-25 21:25:23', 'protected', 'admin', 'admin', 1, 1, 'webmaster@example.com', NULL, NULL, NULL),
(2, 2, '2012-10-25 21:25:23', 'protected', 'demo', 'demo', 1, 1, 'demo@example.com', NULL, NULL, NULL),
(3, 3, '0000-00-00 00:00:00', 'protected', 'Aranda', 'Francisco', 1, 1, 'farandal@gmail.com', 'Av. Los Acacios 5727, Conchali, Santiago', 'Santiago', 'Kauffmann User'),
(4, 4, '0000-00-00 00:00:00', 'protected', 'Pino', 'Guillermo', 1, 1, 'gpino@rway.cl', '', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `profile_comment`
--
...
--
-- Volcar la base de datos para la tabla `profile_comment`
--
...
--
-- Volcar la base de datos para la tabla `profile_field`
--
...
--
-- Estructura de tabla para la tabla `profile_visit`
--
...
CREATE TABLE IF NOT EXISTS `prospecto` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'list,hidden,null',
  `pe_nombre` varchar(255) NOT NULL COMMENT 'required',
  `pe_apellido` varchar(255) NOT NULL COMMENT 'required',
  `pe_rut` varchar(12) NOT NULL COMMENT 'list,required,rut',
  `pe_telefono` varchar(255) DEFAULT NULL,
  `pe_celular` varchar(255) DEFAULT NULL,
  `pe_email` varchar(255) NOT NULL COMMENT 'required,email',
  `em` int(1) DEFAULT '0',
  `em_nombre` varchar(255) DEFAULT NULL,
  `em_rut` varchar(12) DEFAULT NULL COMMENT 'rut',
  `eq_tipo` int(11) unsigned NOT NULL COMMENT 'required',
  `eq_marca` varchar(255) DEFAULT NULL,
  `eq_modelo` varchar(255) DEFAULT NULL,
  `eq_ano` int(4) DEFAULT NULL,
  `eq_estado` int(11) unsigned NOT NULL COMMENT 'list,required',
  `eq_moneda` int(11) NOT NULL,
  `co_moneda` int(11) DEFAULT NULL,
  `co_monto` int(11) NOT NULL COMMENT 'list,required',
  `co_plazo` int(2) NOT NULL COMMENT 'list,required',
  `co_plazo2` int(2) DEFAULT '24',
  `co_plazo3` int(2) DEFAULT '36',
  `co_pie` int(11) NOT NULL COMMENT 'list,required',
  `co_tasa` varchar(2) DEFAULT 'TP',
  `tasa` float DEFAULT NULL,
  `compro` float DEFAULT NULL,
  `comeje` float DEFAULT NULL,
  `co_pie_tipo` int(1) DEFAULT '0',
  `eq_qty` int(4) NOT NULL COMMENT 'list,required',
  `estado` int(1) NOT NULL DEFAULT '1' COMMENT 'list',
  `user_id` int(10) unsigned NOT NULL COMMENT 'list,required',
  `fecha` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'list,hidden,null',
  `organizacion_id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `eq_estado` (`eq_estado`),
  KEY `eq_tipo` (`eq_tipo`),
  KEY `organizacion_id` (`organizacion_id`),
  KEY `co_moneda` (`co_moneda`),
  KEY `eq_moneda` (`eq_moneda`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12 ;

--
-- Volcar la base de datos para la tabla `prospecto`
--

INSERT INTO `prospecto` (`id`, `pe_nombre`, `pe_apellido`, `pe_rut`, `pe_telefono`, `pe_celular`, `pe_email`, `em`, `em_nombre`, `em_rut`, `eq_tipo`, `eq_marca`, `eq_modelo`, `eq_ano`, `eq_estado`, `eq_moneda`, `co_moneda`, `co_monto`, `co_plazo`, `co_plazo2`, `co_plazo3`, `co_pie`, `co_tasa`, `tasa`, `compro`, `comeje`, `co_pie_tipo`, `eq_qty`, `estado`, `user_id`, `fecha`, `organizacion_id`) VALUES
(11, 'TEST', 'TEST', '16.123.292-0', '5699582078', '9995737228', 'FARANDAL@GMAIL.COM', 0, '', '', 10, 'VOLVO', ' FMX 8X4 CON TOLVA 20M3', 2013, 1, 3, 3, 3480, 12, 24, 36, 20, 'TP', 2.5, 3, 1.5, 1, 1, 1, 4, '2012-12-04 09:21:51', 15);
...
(5, 'superadmin', 'Super Administrador', 1, 0, 0),
(6, 'supervisor', 'Supervisor ', 2, 0, 0),
(7, 'ejecutivo', 'Ejecutivo', 3, 0, 0),
(8, 'tasa_admin', 'Administrador de Tasas', NULL, NULL, NULL),
(9, 'comision_admin', 'Administrador de comisiones', NULL, NULL, NULL);
...
INSERT INTO `seguro` (`id`, `tipo`, `r1`, `r2`, `valor`) VALUES
(2, 'VP', 0, 100, 16.788),
(3, 'VP', 101, 200, 16.788),
(4, 'VP', 201, 300, 16.788),
(5, 'VP', 301, 400, 16.788),
...
(8, 'VP', 601, 700, 19.512),
(9, 'VP', 701, 800, 20.64),
(10, 'VP', 801, 900, 21.768),
(11, 'VP', 901, 1000, 22.896),
(12, 'VP', 1001, 1100, 24.048),
(13, 'VP', 1101, 1200, 25.2),
(14, 'VP', 1201, 1300, 26.352),
(15, 'VP', 1301, 1400, 27.528),
(16, 'VP', 1401, 1500, 28.692),
(17, 'VP', 1501, 1600, 29.868),
(18, 'VP', 1601, 1700, 31.044),
(19, 'VP', 1701, 1800, 32.232),
(20, 'VP', 1801, 1900, 33.42),
(21, 'VP', 1901, 2000, 34.62),
(22, 'VP', 2001, 2100, 35.82),
(23, 'VP', 2101, 2200, 37.02),
(24, 'VP', 2201, 2300, 38.22),
(25, 'VP', 2301, 2400, 39.432),
(26, 'VP', 2401, 2500, 40.644),
(27, 'VP', 2501, 2600, 41.856),
(28, 'VP', 2601, 2700, 43.068),
(29, 'VP', 2701, 2800, 44.292),
(30, 'VP', 2801, 2900, 45.516),
(31, 'VP', 2901, 3000, 46.74),
(32, 'VP', 3001, 3100, 47.964),
(33, 'VP', 3101, 3200, 49.188),
(34, 'VP', 3201, 3300, 50.424),
(35, 'VP', 3301, 3400, 51.648),
(36, 'VP', 3401, 3500, 52.884),
(37, 'VP', 3501, 3600, 54.12),
(38, 'VP', 3601, 3700, 55.356),
(39, 'VP', 3701, 3800, 55.428),
(40, 'VP', 3801, 3900, 56.64),
(41, 'VP', 3901, 4000, 57.852),
(42, 'VP', 4001, 4100, 59.064),
(43, 'VP', 4101, 4200, 60.288),
(44, 'VP', 4201, 4300, 61.512),
(45, 'VP', 4301, 4400, 62.724),
(46, 'VP', 4401, 4500, 63.948),
(47, 'VP', 4501, 4600, 65.172),
(48, 'VP', 4601, 4700, 66.396),
(49, 'VP', 4701, 4800, 67.62),
(50, 'VP', 4801, 4900, 68.844),
(51, 'VP', 4901, 5000, 70.032),
(52, 'VP', 5001, 5100, 71.208),
(53, 'VP', 5101, 5200, 72.396),
(54, 'VP', 5201, 5300, 73.584),
(55, 'VP', 5301, 5400, 74.772),
(56, 'VP', 5401, 5500, 75.948),
(57, 'VP', 5501, 5600, 77.136),
(58, 'VP', 5601, 5700, 78.324),
(59, 'VP', 5701, 5800, 79.512),
(60, 'VP', 5801, 5900, 80.7),
(61, 'VP', 5901, 6000, 81.888),
(62, 'VP', 6001, 6100, 83.088),
(63, 'VP', 6101, 6200, 84.276),
(64, 'VP', 6201, 6300, 85.464),
(65, 'VP', 6301, 6400, 86.652),
(66, 'VP', 6401, 6500, 87.84),
(67, 'VP', 6501, 6600, 89.04),
(68, 'VP', 6601, 6700, 90.228),
(69, 'VP', 6701, 6800, 91.428),
(70, 'VP', 6801, 6900, 92.616),
(71, 'VP', 6901, 7000, 93.804),
(72, 'VP', 7001, 7100, 95.004),
(73, 'VP', 7101, 7200, 96.204),
(74, 'VP', 7201, 7300, 97.392),
(75, 'VP', 7301, 7400, 98.592),
(76, 'VP', 7401, 7500, 99.78),
(77, 'VP', 7501, 7600, 100.98),
(78, 'VP', 7601, 7700, 102.18),
(79, 'VP', 7701, 7800, 103.368),
(80, 'VP', 7801, 7900, 104.568),
(81, 'VP', 7901, 8000, 105.768),
(82, 'VP', 8001, 8100, 106.968),
(83, 'VL', 0, 400, 16.728),
(84, 'VL', 401, 600, 18.84),
(85, 'VL', 601, 1000, 23.064),
(86, 'VL', 1001, 1500, 29.4),
(87, 'VL', 1501, 2000, 32.568),
(88, 'VL', 2001, 2500, 35.736),
(89, 'VL', 2501, 3000, 38.904),
(90, 'VL', 3001, 3500, 41.016),
(91, 'VL', 3501, 4000, 43.128),
(92, 'VL', 4001, 99999, 0),
(93, 'VR', 0, 400, 20.952),
(94, 'VR', 401, 600, 23.064),
(95, 'VR', 601, 1000, 27.288),
(96, 'VR', 1001, 1500, 33.624),
(97, 'VR', 1501, 2000, 43.128),
(98, 'VR', 2001, 2500, 47.352),
(99, 'VR', 2501, 3000, 55.092),
(100, 'VR', 3001, 3500, 61.956),
(101, 'VR', 3501, 4000, 68.82),
(102, 'VR', 4001, 99999, 0);
...
CREATE TABLE IF NOT EXISTS `simulacion` (
  ...
  `log1` longtext NOT NULL,
  `log2` longtext NOT NULL,
  `log3` longtext NOT NULL,
  `fecha` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `moneda` varchar(3) DEFAULT 'UF',
  PRIMARY KEY (`id`),
  KEY `prospecto_id` (`prospecto_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=39 ;

--
-- Volcar la base de datos para la tabla `simulacion`
--

INSERT INTO `simulacion` (`id`, `prospecto_id`, `pie`, `c1`, `m1`, `c2`, `m2`, `c3`, `m3`, `monto`, `monto2`, `monto3`, `estado`, `log1`, `log2`, `log3`, `fecha`, `moneda`) VALUES
(28, 11, 696, 12, 282.6, 24, 171.34, 36, 133.97, 3103.88, 3156.77, 3209.65, 1, '{"TIPO MONEDA":"UF","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":57.291,"PIE EN UF":696,"PLAZO":12,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3103.883,"CUOTA":282.6}', '{"TIPO MONEDA":"UF","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":110.175,"PIE EN UF":696,"PLAZO":24,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3156.767,"CUOTA":171.34}', '{"TIPO MONEDA":"UF","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":163.059,"PIE EN UF":696,"PLAZO":36,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3209.651,"CUOTA":133.97}', '2012-12-04 06:24:33', 'UF'),
(29, 11, 1.59379e+07, 12, 6.68339e+06, 24, 4.15141e+06, 36, 3.31559e+06, 7.10767e+07, 7.22878e+07, 7.34988e+07, 1, '{"TIPO MONEDA":"CLP","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR TASA EN CLP":3,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":57.291,"PIE EN UF":696,"PLAZO":12,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3103.883,"CUOTA":291.86}', '{"TIPO MONEDA":"CLP","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR TASA EN CLP":3,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":110.175,"PIE EN UF":696,"PLAZO":24,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3156.767,"CUOTA":181.29}', '{"TIPO MONEDA":"CLP","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR TASA EN CLP":3,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":163.059,"PIE EN UF":696,"PLAZO":36,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3209.651,"CUOTA":144.79}', '2012-12-04 06:25:08', 'CLP'),
(37, 11, 696, 12, 291.86, 24, 181.29, 36, 144.79, 3103.88, 3156.77, 3209.65, 1, '{"TIPO MONEDA":"CLP","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR TASA EN CLP":3,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":57.291,"PIE EN UF":696,"PLAZO":12,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3103.883,"CUOTA":291.86}', '{"TIPO MONEDA":"CLP","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR TASA EN CLP":3,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":110.175,"PIE EN UF":696,"PLAZO":24,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3156.767,"CUOTA":181.29}', '{"TIPO MONEDA":"CLP","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR TASA EN CLP":3,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":163.059,"PIE EN UF":696,"PLAZO":36,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3209.651,"CUOTA":144.79}', '2012-12-04 09:00:42', 'CLP'),
(38, 11, 696, 12, 282.6, 24, 171.34, 36, 133.97, 3103.88, 3156.77, 3209.65, 1, '{"TIPO MONEDA":"UF","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":57.291,"PIE EN UF":696,"PLAZO":12,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3103.883,"CUOTA":282.6}', '{"TIPO MONEDA":"UF","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":110.175,"PIE EN UF":696,"PLAZO":24,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3156.767,"CUOTA":171.34}', '{"TIPO MONEDA":"UF","VALOR UF":"22899.3","VALOR USD":488.28,"VALOR EQUIPO ORIGINAL":"3480","VALOR EQUIPO UF-UF":3480,"VALOR EQUIPO UF":3480,"ppm":40.02,"inscripcion":3,"contabilidad":3,"notaria":3,"meratenencia":1,"transferencia":62.292,"legal_venta":25,"VALOR TASA":2.5,"COMISION % PROVEEDOR":3,"COMISION % EJECUTIVO":1.5,"VALOR SEGURO":52.884,"VALOR SEGURO MESES+1":163.059,"PIE EN UF":696,"PLAZO":36,"EQUIPO - PIE":2784,"MONTO COMISION GLOBAL":125.28,"MONTO COMISION EJECUTIVO":41.76,"MONTO COMISION PROVEEDOR":83.52,"MONTO A FINANCIAR TOTAL INC. COSTOS - COMISION - SEGURO":3209.651,"CUOTA":133.97}', '2012-12-04 09:21:57', 'UF');
...
CREATE TABLE IF NOT EXISTS `tasa` (
  ...
  `tasa` float NOT NULL,
  `compro` float NOT NULL,
  `comeje` float NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=10 ;

--
-- Volcar la base de datos para la tabla `tasa`
--

INSERT INTO `tasa` (`id`, `tipo`, `rango`, `tasa`, `compro`, `comeje`) VALUES
(1, 'TP', 1, 2.5, 3, 1.5),
(2, 'TP', 2, 2.2, 3, 1.5),
(3, 'TP', 3, 2, 3, 1.5),
(4, 'TM', 1, 2.3, 2, 1),
(5, 'TM', 2, 2.1, 2, 1),
(6, 'TM', 3, 1.9, 2, 1),
(7, 'TB', 1, 2.15, 1.3, 0.65),
(8, 'TB', 2, 1.95, 1.3, 0.65),
(9, 'TB', 3, 1.8, 1.3, 0.65);
...
CREATE TABLE IF NOT EXISTS `tipoequipo` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'hidden',
  `code` varchar(32) NOT NULL COMMENT 'list,required',
  `name` varchar(255) NOT NULL COMMENT 'list,required',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14 ;

--
-- Volcar la base de datos para la tabla `tipoequipo`
--

INSERT INTO `tipoequipo` (`id`, `code`, `name`) VALUES
(9, 'VL', 'Vehiculo Liviano'),
(10, 'VP', 'Vehiculo Pesado'),
(11, 'EM', 'Equipo'),
(12, 'O', 'Otros'),
(13, 'D', 'abcd');
...
--
-- Volcar la base de datos para la tabla `translation`
--
...
INSERT INTO `user` (`id`, `username`, `password`, `salt`, `activationKey`, `createtime`, `lastvisit`, `lastaction`, `lastpasswordchange`, `superuser`, `status`, `avatar`, `notifyType`, `organizacion_id`) VALUES
(1, 'admin', '1053453d07b7379469b6c960a2e0e32a4a099c3b7d12972d4ad15b7e3ed4221dbcec598d86c28ef58c5b73016090ecd84a8ce6cde3aac5eb519879156e792bfc', 'xd8CsKCDFV2BfvQGcL8NoH6hSJ7m+ZOYzjXi6Y8gf6OQqLkINHk5+y1XfQqnq36dqrhJ3H3CQD/uOVkgI1/H8w==', '', 1351211123, 1354620743, 1354624841, 0, 1, 1, NULL, 'Instant', 15),
(2, 'demo', 'b7503b53044bb7f74fcb6f1290bbe3620a6e59b5bc714b7c39b61eaee1b05d22590fc0be14c13cbdb0b7d9d54e60ac3ff9b75338609cb3886bb49c910714c957', 'kqRNqWxMv6fdWzpMOiHeXgyKnUhRlQLjkLLPb9Bwog2E5Vms/TpaRvSuC0QQdOpArAq7lpMnEw8apK8nmjX9DA==', '', 1351211123, 1354206880, 0, 0, 0, 1, NULL, 'Instant', 15),
(3, '161232920', '09eba814912c0b3dc98eb529fcd021267887eb1d66148730eeef32ae38b0f3ffaa53f6afff04af573099c568cfedc92ce9ee905f21824419289d0f1e8c5ea8c2', 'TGwsVGT8QzV2rBKRQMmxRqjl2KtoVr0icKACWZKariEM5vpeN/MAPsocc3XcHZPe/wthRO+5NS8Xuo1tbz8ZVw==', 'dfda2d8765f7b108c8f5208d9dd75aea3557d5bf564ec8d0da3b925e09b5632552dd3de49481773cefed75d2776996be8beff48a9a5842acb8294c812235ef59', 1352768728, 1352909206, 0, 1352768902, 0, 1, NULL, 'Instant', 2),
(4, 'gpino', 'a0aa3bdd5669a0cdc77978bcb6540681563e7884cf065536486b8744375898f2098eec1670495363fa0ad280a0729e580d7ed762f72874cc1052db39cc36b2e3', 'eZMR6e26qFla6nSBBUs2tybbZj8uuj+TZNGV0EpqvEDKaFbHdwUlgUUGc46rEOx3LDJheqSx0zqj7WhjIkDSmw==', '56079514258b56c331718dac57fa1e844855cdaf3fc41cf61638cf71fc4a4ef00fcd98cfcad14e6671da08bfc60cf8b8cc347c04b1174faca85575eb8cb4c60d', 1353009218, 1354586151, 0, 1353520091, 1, 1, NULL, 'Instant', 15);
...
--
-- Volcar la base de datos para la tabla `usergroup`
--

INSERT INTO `usergroup` (`id`, `owner_id`, `participants`, `title`, `description`) VALUES
(1, 1, '["1"]', 'RightWay', 'Rightway'),
(2, 1, '["1"]', 'Kauffmann', 'Kauffmann');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `user_group_message`
--
...
--
-- Volcar la base de datos para la tabla `user_group_message`
--
...
ALTER TABLE `prospecto`
  ADD CONSTRAINT `prospecto_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `prospecto_ibfk_2` FOREIGN KEY (`eq_tipo`) REFERENCES `tipoequipo` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `prospecto_ibfk_3` FOREIGN KEY (`eq_estado`) REFERENCES `estado` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `prospecto_ibfk_4` FOREIGN KEY (`organizacion_id`) REFERENCES `organizacion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `prospecto_ibfk_5` FOREIGN KEY (`co_moneda`) REFERENCES `moneda` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `prospecto_ibfk_6` FOREIGN KEY (`eq_moneda`) REFERENCES `moneda` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `simulacion`
--
ALTER TABLE `simulacion`
  ADD CONSTRAINT `simulacion_ibfk_1` FOREIGN KEY (`prospecto_id`) REFERENCES `prospecto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`organizacion_id`) REFERENCES `organizacion` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
