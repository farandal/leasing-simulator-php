...
class YumUser extends YumActiveRecord
{
	...
	public function rules()
	{
		...
		$rules[] = array('username, createtime, lastvisit, lastpasswordchange,organizacion_id, superuser, status', 'required');
	...
	public function relations()
	{
		Yii::import('application.modules.profile.models.*');
                //echo "cache"; print_r(Yii::app()); die();
		...
		if($relations === false) {
			...
			if (Yum::hasModule('membership')) {
				...
				$relations['memberships'] = array(
                        ...
                        $relations['organizacion'] = array(self::HAS_ONE, 'Organizacion', 'organizacion_id');
                                                
                                                //$relations['organizacion'] = array(self::BELONGS_TO, 'Organizacion', 'organizacion_id');
